	...
	<main>
		<div class="datenschutz">
			...
			<p>
				...
				sogenannten Logdatei. Wir haben keinen Zugriff auf diese Logdateien.
				Mehr Informationen dazu, wie Netlify Ihre Daten verarbeitet, können Sie
				der
				...
				Uhrzeit der Anfrage, Übertragene Datenmenge, Zugriffsstatus
				(HTTP-Status) und Websites, von denen das System des Nutzers auf unsere
				Internetseite gelangt (Referrer URL). Diese Daten werden von Netlify für
				30 Tage gespeichert. Weitere Details dazu finden Sie der
				<a href="https://www.netlify.com/gdpr-ccpa"
					>Verpflichtung von Netlify </a
...
noreferrer"
			...
			<p>
				...
				Website. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt
			...
			<p>
				...
				Dublin 4, Irland. Mit Hilfe dieses Dienstes k&ouml;nnen wir
...
noreferrer"
			...
			<p>
				...
				Gro&szlig;britannien gilt als datenschutzrechtlich sicherer Drittstaat.
				Das bedeutet, dass Gro&szlig;britannien ein Datenschutzniveau aufweist,
				das dem Datenschutzniveau in der Europ&auml;ischen Union entspricht. Bei
				der Nutzung der OpenStreetMap- Karten wird eine Verbindung zu den
				Servern der OpenStreetMap-Foundation hergestellt. Dabei k&ouml;nnen
				u.&nbsp;a. Ihre IP-Adresse und weitere Informationen &uuml;ber Ihr
				Verhalten auf dieser Website an die OSMF weitergeleitet werden.
				OpenStreetMap speichert hierzu unter Umst&auml;nden Cookies in Ihrem
